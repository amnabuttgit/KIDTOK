...
const BACKEND_URL = 'http://10.11.25.163:3001/api/videos';

// URL to create payment on backend server
const STRIPE_PAYMENT_URL = 'http://10.11.25.163:3001/api/create-payment';

// URL to confirm payment on backend server
const STRIPE_CONFIRM_URL = 'http://10.11.25.163:3001/api/confirm-payment';
